    ...
    <Dialog open={show}>
      <DialogContent>
        <DialogContentText align='center'>
          W ciągu kilku minut otrzymasz wiadomość na Twój nowy adres email z
          potwierdzeniem dokonanej zmiany. Prosimy o sprawdzenie swojej skrzynki
          odbiorczej i potwierdzenie zmiany, w innym przypadku adres
          email nie zostanie zmieniony.
        </DialogContentText>
