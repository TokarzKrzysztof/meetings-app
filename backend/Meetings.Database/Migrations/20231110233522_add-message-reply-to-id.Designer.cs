...
namespace Meetings.Database.Migrations
{
    ...
    [Migration("20231110233522_add-message-reply-to-id")]
    partial class addmessagereplytoid
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatUser", b =>
                {
                    b.HasOne("Meetings.Models.Entities.Chat", null)
                        .WithMany()
                        .HasForeignKey("ChatsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Meetings.Models.Entities.User", null)
                        .WithMany()
